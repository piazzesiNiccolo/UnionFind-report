...
\end{lstlisting}
\paragraph{Path splitting} \cite{van1977alternative} make the node $u_i (0 \leq i \leq l-3)$ a child of its grandparent $u_{i+2}$ 
\begin{lstlisting}
...
\end{lstlisting}
\paragraph{Path halving} \cite{van1977alternative} make the node $u_{2i} ( 0 \leq i \leq \lfloor \frac{l-1}{2}\rfloor - 1)$ a child 
...
\subsection{Detect cycle in a graph}
