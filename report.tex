...
In QuickUnion we also use trees, but they can have height $\geq$ 1. Each element has a pointer to their
...
\begin{figure}[h!]
    ...
    \caption{makeSet(x), union(A,B) and find(x) in QuickUnion}
